...
// AÑADIR VALIDACIÓN AL ABRIR LOS ARCHIVOS
// Arreglar el formato del archivo de salida
// Areglar los formatos de todo el programa y todas las salidas
// terminar última opción
// OPCIONAL QUE LA LECTURA DE TEMPENTRADA NO TENGA UNA CANTIDAD FIJA DE COMENTARIOS (se puede hacer un contador para la cantidad de comentarios)
        ...
        void ConvertMorse() {
            ...
            for ( i = 0; i < input.length() ; i++) {
                ...
                if ( interpreter[1][ind-1] == "........" ) {
                    ...
                    if ( interpreter[1][ind-1] == "/" || i + length - 1 > input.length() ) {
